...
<div id="div-container">
    <div id="board_area">
        ...
        <table class="list-table">
            ...
            <?php
            $sql = mq("select * from mrk_requirement order by idx desc limit 0,5");
            while($board = $sql->fetch_array())
            {
                ...
                <tr>
                    ...
                    <td width="500"><a href="/page/requirement/read.php?idx=<?php echo $board["idx"];?>"><?php echo $title;?></a></td>
        ...
        <div id="write_btn">
            <a href="/page/requirement/write.php"><button>글쓰기</button></a>
        </div>
    </div>
</div>
</body>
